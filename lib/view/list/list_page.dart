                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 20,),
                        Flexible(child: Text(todoList[index].content, style: TextStyle(fontSize: 20),)),
                        SizedBox(width: 20,),
                        ElevatedButton(
                            onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => DetailPage(todoList: todoList[index],)));},
                            child: Text('詳細')),
                      ],
                    ),
